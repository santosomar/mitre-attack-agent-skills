# Hunt Plan: T1625.001 System Runtime API Hijacking

## Hypothesis

Adversary behavior consistent with T1625.001 System Runtime API Hijacking may be present in the environment.
