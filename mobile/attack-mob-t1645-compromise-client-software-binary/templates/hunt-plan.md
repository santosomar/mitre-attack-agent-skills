# Hunt Plan: T1645 Compromise Client Software Binary

## Hypothesis

Adversary behavior consistent with T1645 Compromise Client Software Binary may be present in the environment.
