# Hunt Plan: T1398 Boot or Logon Initialization Scripts

## Hypothesis

Adversary behavior consistent with T1398 Boot or Logon Initialization Scripts may be present in the environment.
