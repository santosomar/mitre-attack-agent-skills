# Hunt Plan: T1634 Credentials from Password Store

## Hypothesis

Adversary behavior consistent with T1634 Credentials from Password Store may be present in the environment.
