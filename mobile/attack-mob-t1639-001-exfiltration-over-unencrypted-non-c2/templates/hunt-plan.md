# Hunt Plan: T1639.001 Exfiltration Over Unencrypted Non-C2 Protocol

## Hypothesis

Adversary behavior consistent with T1639.001 Exfiltration Over Unencrypted Non-C2 Protocol may be present in the environment.
