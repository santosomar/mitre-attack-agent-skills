# Hunt Plan: T1623 Command and Scripting Interpreter

## Hypothesis

Adversary behavior consistent with T1623 Command and Scripting Interpreter may be present in the environment.
