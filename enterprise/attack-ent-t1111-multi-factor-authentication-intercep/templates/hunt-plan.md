# Hunt Plan: T1111 Multi-Factor Authentication Interception

## Hypothesis

Adversary behavior consistent with T1111 Multi-Factor Authentication Interception may be present in the environment.
