# Hunt Plan: T1552.005 Cloud Instance Metadata API

## Hypothesis

Adversary behavior consistent with T1552.005 Cloud Instance Metadata API may be present in the environment.
