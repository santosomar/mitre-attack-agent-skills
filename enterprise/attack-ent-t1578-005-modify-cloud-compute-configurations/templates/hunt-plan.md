# Hunt Plan: T1578.005 Modify Cloud Compute Configurations

## Hypothesis

Adversary behavior consistent with T1578.005 Modify Cloud Compute Configurations may be present in the environment.
