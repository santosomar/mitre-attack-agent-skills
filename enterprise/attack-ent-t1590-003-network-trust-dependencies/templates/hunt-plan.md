# Hunt Plan: T1590.003 Network Trust Dependencies

## Hypothesis

Adversary behavior consistent with T1590.003 Network Trust Dependencies may be present in the environment.
