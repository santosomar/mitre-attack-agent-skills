# Hunt Plan: T1621 Multi-Factor Authentication Request Generation

## Hypothesis

Adversary behavior consistent with T1621 Multi-Factor Authentication Request Generation may be present in the environment.
