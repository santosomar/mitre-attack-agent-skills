# Hunt Plan: T1685.001 Disable or Modify Windows Event Log

## Hypothesis

Adversary behavior consistent with T1685.001 Disable or Modify Windows Event Log may be present in the environment.
