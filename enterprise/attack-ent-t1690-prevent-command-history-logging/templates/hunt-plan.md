# Hunt Plan: T1690 Prevent Command History Logging

## Hypothesis

Adversary behavior consistent with T1690 Prevent Command History Logging may be present in the environment.
