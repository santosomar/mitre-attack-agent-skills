---
name: attack-ent-t1602-001-snmp-mib-dump
...
metadata:
  ...
  domain: enterprise
  attack_id: T1602.001
  attack_stix_id: attack-pattern--ee7ff928-801c-4f34-8a99-3df965e581a5
  attack_version: "1.1"
  attack_modified: "2025-10-24T17:49:34.969Z"
---

# MITRE ATT&CK T1602.001: SNMP (MIB Dump)

## When to use this skill

Use this skill when the task involves T1602.001, SNMP (MIB Dump), enterprise ATT&CK, TTP mapping, detection engineering, hunting, incident-response enrichment, control validation, or authorized adversary-emulation planning. Treat it as a defensive analysis aid: keep outputs focused on understanding, detecting, mitigating, and safely validating this ATT&CK sub-technique.

## Technique context

- ATT&CK domain: enterprise
- ATT&CK ID: T1602.001
- Technique name: SNMP (MIB Dump)
- Type: sub-technique
- ATT&CK URL: https://attack.mitre.org/techniques/T1602/001
- Tactics: collection
