# Hunt Plan: T1556.003 Pluggable Authentication Modules

## Hypothesis

Adversary behavior consistent with T1556.003 Pluggable Authentication Modules may be present in the environment.
