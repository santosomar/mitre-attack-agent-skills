# Hunt Plan: T1602.002 Network Device Configuration Dump

## Hypothesis

Adversary behavior consistent with T1602.002 Network Device Configuration Dump may be present in the environment.
