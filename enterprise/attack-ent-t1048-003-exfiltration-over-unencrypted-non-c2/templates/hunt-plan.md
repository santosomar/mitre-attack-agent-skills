# Hunt Plan: T1048.003 Exfiltration Over Unencrypted Non-C2 Protocol

## Hypothesis

Adversary behavior consistent with T1048.003 Exfiltration Over Unencrypted Non-C2 Protocol may be present in the environment.
