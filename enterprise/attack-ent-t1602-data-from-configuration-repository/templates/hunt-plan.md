# Hunt Plan: T1602 Data from Configuration Repository

## Hypothesis

Adversary behavior consistent with T1602 Data from Configuration Repository may be present in the environment.
