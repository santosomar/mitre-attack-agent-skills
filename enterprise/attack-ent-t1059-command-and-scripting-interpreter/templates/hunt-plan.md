# Hunt Plan: T1059 Command and Scripting Interpreter

## Hypothesis

Adversary behavior consistent with T1059 Command and Scripting Interpreter may be present in the environment.
