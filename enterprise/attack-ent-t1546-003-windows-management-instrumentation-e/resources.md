# Resources for T1546.003: Windows Management Instrumentation Event Subscription

This directory is a self-contained resource bundle for the `T1546.003` ATT&CK skill.
