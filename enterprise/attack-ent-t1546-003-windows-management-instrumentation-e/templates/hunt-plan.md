# Hunt Plan: T1546.003 Windows Management Instrumentation Event Subscription

## Hypothesis

Adversary behavior consistent with T1546.003 Windows Management Instrumentation Event Subscription may be present in the environment.
