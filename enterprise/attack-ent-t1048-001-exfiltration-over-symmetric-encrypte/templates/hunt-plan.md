# Hunt Plan: T1048.001 Exfiltration Over Symmetric Encrypted Non-C2 Protocol

## Hypothesis

Adversary behavior consistent with T1048.001 Exfiltration Over Symmetric Encrypted Non-C2 Protocol may be present in the environment.
