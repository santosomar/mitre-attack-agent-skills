---
name: attack-ent-t1216-002-syncappvpublishingserver
description: "Analyze MITRE ATT&CK T1216.002 SyncAppvPublishingServer in the enterprise matrix. Use for TTP triage, detection engineering, hunting, defensive emulation planning, mitigations, incident response mapping, ATT&CK coverage, or questions mentioning T1216.002, SyncAppvPublishingServer, or enterprise ATT&CK. Adversaries may abuse SyncAppvPublishingServer.vbs to proxy execution of malicious [PowerShell](https://attack.mitre.org/techniques/T1059/001) commands."
license: MITRE ATT&CK Terms of Use apply to ATT&CK-derived content. See https://attack.mitre.org/resources/terms-of-use/
metadata:
  source: mitre-attack/attack-stix-data
  domain: enterprise
  attack_id: T1216.002
  attack_stix_id: attack-pattern--e6f19759-dde3-47fc-99cc-d9f5fa4ade60
  attack_version: "2.0"
  attack_modified: "2026-04-15T22:42:56.654Z"
---

# MITRE ATT&CK T1216.002: SyncAppvPublishingServer

## When to use this skill

Use this skill when the task involves T1216.002, SyncAppvPublishingServer, enterprise ATT&CK, TTP mapping, detection engineering, hunting, incident-response enrichment, control validation, or authorized adversary-emulation planning. Treat it as a defensive analysis aid: keep outputs focused on understanding, detecting, mitigating, and safely validating this ATT&CK sub-technique.

## Technique context

- ATT&CK domain: enterprise
- ATT&CK ID: T1216.002
- Technique name: SyncAppvPublishingServer
- Type: sub-technique
- ATT&CK URL: https://attack.mitre.org/techniques/T1216/002
- Tactics: stealth
- Platforms: Windows
