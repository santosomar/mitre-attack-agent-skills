# Hunt Plan: T1036.011 Overwrite Process Arguments

## Hypothesis

Adversary behavior consistent with T1036.011 Overwrite Process Arguments may be present in the environment.
