# Hunt Plan: T1574.009 Path Interception by Unquoted Path

## Hypothesis

Adversary behavior consistent with T1574.009 Path Interception by Unquoted Path may be present in the environment.
