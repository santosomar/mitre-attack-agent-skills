# Hunt Plan: T1535 Unused/Unsupported Cloud Regions

## Hypothesis

Adversary behavior consistent with T1535 Unused/Unsupported Cloud Regions may be present in the environment.
