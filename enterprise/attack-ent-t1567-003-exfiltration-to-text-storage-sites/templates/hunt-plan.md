# Hunt Plan: T1567.003 Exfiltration to Text Storage Sites

## Hypothesis

Adversary behavior consistent with T1567.003 Exfiltration to Text Storage Sites may be present in the environment.
