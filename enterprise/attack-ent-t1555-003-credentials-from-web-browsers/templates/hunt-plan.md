# Hunt Plan: T1555.003 Credentials from Web Browsers

## Hypothesis

Adversary behavior consistent with T1555.003 Credentials from Web Browsers may be present in the environment.
