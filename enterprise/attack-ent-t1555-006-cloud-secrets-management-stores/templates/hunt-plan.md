# Hunt Plan: T1555.006 Cloud Secrets Management Stores

## Hypothesis

Adversary behavior consistent with T1555.006 Cloud Secrets Management Stores may be present in the environment.
