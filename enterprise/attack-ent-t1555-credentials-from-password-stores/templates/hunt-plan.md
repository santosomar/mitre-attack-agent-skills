# Hunt Plan: T1555 Credentials from Password Stores

## Hypothesis

Adversary behavior consistent with T1555 Credentials from Password Stores may be present in the environment.
