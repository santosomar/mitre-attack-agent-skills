# Hunt Plan: T1574.008 Path Interception by Search Order Hijacking

## Hypothesis

Adversary behavior consistent with T1574.008 Path Interception by Search Order Hijacking may be present in the environment.
