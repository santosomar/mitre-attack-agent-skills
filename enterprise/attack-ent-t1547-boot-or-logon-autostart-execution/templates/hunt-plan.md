# Hunt Plan: T1547 Boot or Logon Autostart Execution

## Hypothesis

Adversary behavior consistent with T1547 Boot or Logon Autostart Execution may be present in the environment.
