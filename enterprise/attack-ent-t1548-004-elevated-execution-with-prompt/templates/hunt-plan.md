# Hunt Plan: T1548.004 Elevated Execution with Prompt

## Hypothesis

Adversary behavior consistent with T1548.004 Elevated Execution with Prompt may be present in the environment.
