# Hunt Plan: T1574.007 Path Interception by PATH Environment Variable

## Hypothesis

Adversary behavior consistent with T1574.007 Path Interception by PATH Environment Variable may be present in the environment.
