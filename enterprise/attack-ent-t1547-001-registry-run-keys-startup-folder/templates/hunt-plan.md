# Hunt Plan: T1547.001 Registry Run Keys / Startup Folder

## Hypothesis

Adversary behavior consistent with T1547.001 Registry Run Keys / Startup Folder may be present in the environment.
