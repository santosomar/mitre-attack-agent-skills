# Hunt Plan: T1048.002 Exfiltration Over Asymmetric Encrypted Non-C2 Protocol

## Hypothesis

Adversary behavior consistent with T1048.002 Exfiltration Over Asymmetric Encrypted Non-C2 Protocol may be present in the environment.
